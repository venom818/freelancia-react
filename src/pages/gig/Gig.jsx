      ...
      <div className="container">
          ...
          <div className="seller">
            ...
            <div className="user">
              <img
                ...
                alt=""
              />
              <div className="info"> {/* Added info div for better alignment */}
                <span>Jane Doe</span>
                <div className="stars">
                  <img src="/img/5stars.png" alt="" />
                  {/* <img src="/img/5stars.png" alt="" />
          ...
          <div className="reviews">
            ...
            <div className="item">
              <div className="user">
                ...
                <div className="info">
                  <span>Jane Doe</span>
                  <div className="country"> {/* Corrected class name to 'country' */}
              ...
              <div className="user">
                ...
                <div className="info">
                  ...
                  <div className="country">
                    <img src="https://flagpedia.net/data/flags/icon/96x54/us.png" alt="" /> {/* Added missing image src */}
                    <span>Nepal</span>
                  </div>
                </div>
              </div>
        ...
        <div className="right">
          ...
          <div className="details">
            ...
            <div className="item">
              <img src="/img/recycle.png" alt="" /> {/* Changed icon to represent revisions */}
              <span>3 Revisions</span>
            </div>
          </div>
          <div className="features">
            <div className="item">
              <img src="/img/check.png" alt="" /> {/* Changed icon for features */}
